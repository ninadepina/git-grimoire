<script>
	...
	import { getFileContents } from '../../../../lib/api.js';
	...
	<header>
		<section>
			<div>
				...
				<h1>STATIC USERNAME <span>/</span> <span>STATIC REPO NAME</span></h1>
				<p>Public</p>
			</div>
			<div>
		...
		<table>
			<tr>
				<th>
					<div>
						<img
							src="https://avatars.githubusercontent.com/u/89778503?s=48&v=4"
							alt="@STATICUSERNAME GitHub avatar"
						/>
						<h3>STATIC USERNAME</h3>
						<p>[added] fix</p>
					</div>
					<div>
						<p>STATIC UPDATE</p>
